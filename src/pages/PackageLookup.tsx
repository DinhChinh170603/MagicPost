...
export default function PackageLookup() {
  ...
  return (
    <div className="flex h-screen w-screen items-center justify-center gap-5 bg-[#f1f5f9]">
      <div className="flex flex-col items-center">
        <img src="/src/assets/biglogo.svg" />
        <h1 className="-mt-5 text-[80px] font-bold">Magic Post</h1>
      </div>
